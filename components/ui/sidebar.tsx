...
function SidebarProvider({
  ...
  // Always use defaultOpen for initial render to avoid hydration mismatches
  const [_open, _setOpen] = React.useState(defaultOpen)
  const open = openProp ?? _open

  // Read from cookie after mount to restore previous state (client-side only)
  React.useEffect(() => {
    if (openProp !== undefined) {
      // If controlled, don't read from cookie
      return
    }
    try {
      ...
      // Ignore errors when reading cookies (e.g., in test environments)
    }
